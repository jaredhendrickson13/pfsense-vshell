...
class PFClient:
    def __init__(self, host, user="admin", password="pfsense", port=443, scheme="https", timeout=30, verify=True):
        """
        Initializes the object at creation
        :param host: (string) the IP or hostname of the remote pfSense host
        :param user: (string) the pfSense user to authenticate as. Defaults to admin.
        :param password: (string) the password for the pfSense user. Defaults to pfsense.
